...
var subTargetLogoAfter = subTarget.querySelector(
  '[data-preloader="sub-logo-after"]'
);
var subDone = 0;
var subLoadFlag = 0;

gsap.to(subTargetLogoAfter, {
  clipPath: "inset(0% 0% 0% 0%)",
  opacity: 0.8,
  duration: 0.8,
  ease: "power3.inOut",
...
function subLoadDone() {
  gsap.to(subTargetCover, {
    // clipPath: "inset(0% 0% 100% 0%)",
    opacity: 0,
    duration: 0.8,
    //delay: 2,
  ...
  gsap.to(subTargetLogo, {
    y: -window.innerHeight * 0.01,
    duration: 0.6,
    //delay: 2,
    ease: "power3.inOut",
  });
  gsap.to("#ssh_preloader-sub", {
    // delay: 1,
    duration: 0.8,
    display: "none",
  });
